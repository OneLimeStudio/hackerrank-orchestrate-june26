...
## Anti-Hallucination
- **Hallucinated image IDs stripped**: 6
- **Anti-hallucination claim downgrades**: 6

## Evidence Standard Disagreement
- **Model vs computed disagreements**: 2/17 (11.8%)
...
- **Model calls (Layer 2)**: 1
- **Approx input tokens**: 7,982
- **Approx output tokens**: 150
- **Estimated API cost**: $0.00064
